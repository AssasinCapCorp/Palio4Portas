...
//      String nomedoUser, int segunda, int terca, int quarta, int quinta, int sexta, int sabado, int domingo
        ...
        CalendarioSemanal ca = new CalendarioSemanal(preferenceManager.getString(Constants.KEY_NAME,null), s,t,qa,qi,sx,sb,d);
//        Muleta.setCs(ca);
//        Muleta.usuario2 = usuario;
        ca.salvar_bd();
//        usuario.salvar_bd();
        preferenceManager.putString(Constants.KEY_CALENDARIO_SEMANAL,preferenceManager.getString(Constants.KEY_NAME,null)+","+s+","+t+","+qa+","+qi+","+sx+","+sb+","+d);
